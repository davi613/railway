...
<style>
    ...
    .bph-form-card-head h4 {
        margin: 0; font-size: 1.1rem; font-weight: 700; color: #F97316;
...
<div class="bph-page-head">
    <div>
        <h1 class="bph-page-title">Edit Obat</h1>
...
<div class="bph-form-card">
    <div class="bph-form-card-head">
        <h4><i class="bi bi-pencil-square"></i> Edit Data Obat</h4>
    </div>
    <div class="bph-form-body">
        <form action="{{ route('obat.update', $obat->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="bph-form-group">
                ...
                <input type="text" class="bph-form-control" id="nama_obat" name="nama_obat" value="{{ $obat->nama_obat }}" required>
            </div>
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    <div class="bph-form-group">
                        ...
                        <input type="number" class="bph-form-control" id="harga_jual" name="harga_jual" value="{{ $obat->harga_jual }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="bph-form-group">
                        <label class="bph-form-label" for="stok">Stok</label>
                        <input type="number" class="bph-form-control" id="stok" name="stok" value="{{ $obat->stok }}" required>
                    </div>
                </div>
            </div>
            ...
            <div class="bph-form-group">
                ...
                <textarea class="bph-form-control" id="deskripsi_obat" name="deskripsi_obat" rows="4">{{ $obat->deskripsi_obat }}</textarea>
            </div>
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    <div class="bph-form-group">
                        ...
                        @if ($obat->foto1)
                            <img src="{{ asset('storage/' . $obat->foto1) }}" alt="Foto 1" class="bph-img-preview">
                        @endif
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="bph-form-group">
                        ...
                        @if ($obat->foto2)
                            <img src="{{ asset('storage/' . $obat->foto2) }}" alt="Foto 2" class="bph-img-preview">
                        @endif
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="bph-form-group">
                        ...
                        @if ($obat->foto3)
                            <img src="{{ asset('storage/' . $obat->foto3) }}" alt="Foto 3" class="bph-img-preview">
                        @endif
                    </div>
                </div>
            </div>
