...
<div class="bph-page-head">
    <div>
        <h1 class="bph-page-title">Tambah Pembelian</h1>
...
<div class="bph-form-card">
    <div class="bph-form-card-head">
        <h4><i class="bi bi-plus-circle"></i> Tambahkan Pembelian</h4>
    </div>
    <div class="bph-form-body">
        <form action="{{ route('pembelian.store') }}" method="POST">
            ...
            <div class="bph-form-group">
                ...
                <input type="number" class="bph-form-control" id="nonota" name="nonota" required maxlength="100">
            </div>

            <div class="bph-form-group">
                <label class="bph-form-label" for="tgl_pembelian">Tanggal Pembelian</label>
                <input type="date" class="bph-form-control" id="tgl_pembelian" name="tgl_pembelian" required>
            </div>

            <div class="bph-form-group">
                <label class="bph-form-label" for="total_bayar">Total Bayar</label>
                <input type="number" step="0.01" class="bph-form-control" id="total_bayar" name="total_bayar" required>
            </div>
