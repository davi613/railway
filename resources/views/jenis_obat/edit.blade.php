...
<style>
    ...
    .bph-hint { font-size:0.78rem; color:#94A3B8; margin-top:5px; }
...
<div class="bph-page-head">
    <div>
        <h1 class="bph-page-title">Edit Jenis Obat</h1>
...
<div class="bph-form-card">
    <div class="bph-form-card-head">
        <h4><i class="bi bi-pencil-square"></i> Edit Jenis Obat</h4>
    </div>
    <div class="bph-form-body">
        <form action="{{ route('jenis_obat.update', $jenisObat->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="bph-form-group">
                ...
                <input type="text" class="bph-form-control" id="jenis" name="jenis" value="{{ $jenisObat->jenis }}" required>
            </div>

            <div class="bph-form-group">
                <label class="bph-form-label" for="deskripsi_jenis">Deskripsi</label>
                <textarea class="bph-form-control" id="deskripsi_jenis" name="deskripsi_jenis" rows="4">{{ $jenisObat->deskripsi_jenis }}</textarea>
            </div>
            ...
            <div class="bph-form-group">
                ...
                @if($jenisObat->image_url)
                    <img src="{{ asset('storage/'.$jenisObat->image_url) }}" alt="{{ $jenisObat->jenis }}" class="bph-img-preview">
                    <span class="bph-hint">Biarkan kosong jika tidak ingin mengubah gambar</span>
                @endif
            </div>
